...
import {FULL_TIME, RADIUS, MIN_TIME} from "../data/game-const-data";
import {getRadius, getMin, getSec} from "../utilities/update-time";

export default class ViewHeader extends AbstractView {
  constructor(state) {
    super();
    this.state = state;
    this.time = FULL_TIME;
